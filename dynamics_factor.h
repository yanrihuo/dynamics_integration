...
class dynamicsFactor : public ceres::SizedCostFunction<15, 7, 9, 7, 9>
{
public:
	...
	virtual bool Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
	{
		...
		residual = dynamics_integration->evaluate(Pi, Qi, Vi, Bai, Bgi,
			Pj, Qj, Vj, Baj, Bgj);

		Eigen::Matrix<double, 15, 15> sqrt_info = Eigen::LLT<Eigen::Matrix<double, 15, 15>>(dynamics_integration->covariance.inverse()).matrixL().transpose();
